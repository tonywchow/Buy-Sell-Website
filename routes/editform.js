...
router.get("/", (req, res) => {
  databaseQueries
    .getProductWithId(2) //currently the productID is hardcoded in the method for testing. Medhanie to integrate
    .then((product) => {
...
router.post("/", (req, res) => {
  ...
  databaseQueries
    .editProduct(2, changesToProduct) //currently the productID is hardcoded in the method for testing. Medhanie to integrate. editProduct function takes in two parameters, the productID and the information from the forms through req.body
